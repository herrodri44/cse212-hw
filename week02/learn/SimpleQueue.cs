public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: the Dequeue method was trying to remove an item outside the range of the list
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: It was displaying the dequeued values in the wrong order
        ...
        // Defect(s) Found: no defect was found
    }
